 ...
 */
(function(a) { if (typeof define === "function" && define.amd) { define(["jquery"], a) } else { if (typeof exports === "object") { a(require("jquery")) } else { a(jQuery) } } }(function(b) {
    ...
    b.mask_fullscreen = function(e) {
        if (b(".mask[ele=full_screen]").length > 0) { return }
    ...
    b.mask_element = function(f, e) {
        if (b(".mask[ele=" + f + "]").length > 0) { return }
        ...
        clearTimeout(a[f]);
        if (e && e > 0) {
            var d = setTimeout(function() { b(".mask[ele=" + f + "]").remove() }, e);
            a[f] = d
        }
    };
    b.mask_close = function(c) { b(".mask[ele=" + c + "]").remove() };
    b.mask_close_all = function() { b(".mask").remove() }
}));